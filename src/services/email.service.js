...
const sendTransactionEmail = async (userEmail, name, amount, toAccount) => {
    ...
    const html = `<p>Hi ${name},</p><p>You have successfully transferred <strong>${amount}</strong> to account <strong>${toAccount}</strong>.</p><p>Best regards,<br>The Backend Ledger Team</p>`;
...
const sendTransactionFailureEmail = async (userEmail, name, amount, toAccount) => {
    ...
    const html = `<p>Hi ${name},</p><p>Your transaction of <strong>${amount}</strong> to account <strong>${toAccount}</strong> has failed. Please try again later.</p><p>Best regards,<br>The Backend Ledger Team</p>`;
